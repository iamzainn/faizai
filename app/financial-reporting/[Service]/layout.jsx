...
const FinancialReportingDynamicHeroLayout = (params) => {
    const service = (params.params.Service);
    const imageSrc=service === "bookkeeping" ? '/BookKeeping.jpg' : service === "Accounting" ? '/acounting.jpg' : service === "Fractional%20CFO" ? '/CFO.jpg' : '/Financial.png' 
...
export default FinancialReportingDynamicHeroLayout;
